...
const Footer = () => {
  return (
    <footer className="bg-cyan-100/70 md:px-36 text-left w-full mt-10">
      <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">

        <div className="flex flex-col md:items-start items-center w-full">
          <img src={assets.logo_dark} alt="logo" />
          <p className="mt-6 text-center md:text-left text-sm text-black">
        ...
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <ul className="flex md:flex-col w-full justify-between text-sm text-black md:space-y-2">
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <div className="flex items-center gap-2 pt-4">
            <input className="border border-gray-500/30 bg-gray-800 text-black placeholder-black outline-none w-64 h-9 rounded px-2 text-sm" type="email" placeholder="Enter your email" />
