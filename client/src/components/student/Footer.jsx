...
const Footer = () => {
  return (
    <footer className="bg-cyan-700 md:px-36 text-left w-full mt-10">
      <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <div className="flex items-center gap-2 pt-4">
            <input className="border border-gray-500/30 bg-cyan-800 text-white placeholder-white outline-none w-64 h-9 rounded px-2 text-sm" type="email" placeholder="Enter your email" />
            <button className="bg-white w-24 h-9 text-cyan-700 rounded">Subscribe</button>
          </div>
        </div>
